...
-- -----------------------------------------------------
-- Table `FestivalDB`.`Fetival_participant`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `FestivalDB`.`Fetival_participant` (
  ...
  CONSTRAINT `fk_participant_id`
    ...
    REFERENCES `FestivalDB`.`Participant` (`participant_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `FestivalDB`.`Festival_performer`
-- -----------------------------------------------------
...
-- -----------------------------------------------------
-- Table `FestivalDB`.`role`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `FestivalDB`.`role` (
...
-- -----------------------------------------------------
-- Table `FestivalDB`.`user_role`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `FestivalDB`.`user_role` (
  ...
  CONSTRAINT `fk_role_id`
    FOREIGN KEY (`role_id`)
    REFERENCES `FestivalDB`.`role` (`role_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
